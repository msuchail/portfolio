...
{{--    <div class="container mx-auto text-center flex flex-col gap-8">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-12">
            <x-ui.custom-card class="shadow-5xl shadow-indigo-600/50 hover:scale-110 bg-slate-950 p-6 rounded-lg flex flex-col items-center gap-12 transition-all delay-100 ease-in ring-1 ring-indigo-600 hover:ring-indigo-300">
                <div class="flex gap-3 items-center text-white"><x-fas-user-tie class="h-8" /><h3 class="text-xl md:text-2xl font-bold">Professionnel</h3></div>
                <div class="h-72">

                </div>
            </x-ui.custom-card>
            <x-ui.custom-card class="shadow-5xl shadow-indigo-600/50  hover:scale-110 bg-slate-950 p-6 rounded-lg flex flex-col items-center gap-12 transition-all delay-100 ease-in ring-1 ring-indigo-600 hover:ring-indigo-300">
                <div class="flex gap-3 items-center text-white"><x-heroicon-c-academic-cap class="h-8" /><h3 class="text-xl md:text-2xl font-bold">Scolaire</h3></div>
                <div class="h-72">
